  ...
  return (
    <div className=" flex bg-gray-100 flex-col gap-10 items-center h-fit p-3 pb-20">
      ...
      <label className="flex justify-center mb-4">
        <div className={`"border relative p-2 border-gray-600 focus:outline-0 rounded-full h-24 w-24 hover:cursor-pointer  
       ...
       <label className="text-left sm:pl-6 lg:pl-12">
          ...
          <input className="border hover:cursor-pointer  pl-2 p-2 shrink focus:outline-0 sm:mt-0 mt-1 md:ml-3  rounded sm:w-3/4 w-full" type="text" placeholder="Enter Username..."/>
       </label>
       ...
       <label className="text-left sm:pl-6 lg:pl-12">
          ...
          <select className="border hover:cursor-pointer  rounded sm:ml-8 p-2 ml-2" name="user-gender" >
       ...
       <label className="text-left sm:pl-6 lg:px-12">
          ...
          <textarea className="border hover:cursor-pointer  p-2 shrink focus:outline-0 h-22  mt-2 pl-2 rounded  w-full" placeholder="User's Interested Info.."/>
       </label>
