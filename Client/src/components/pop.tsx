  ...
  return (
    ...
    <div className=" bg-gray-100 rounded-2xl px-3 py-4  md:h36 h-fit w-58 md:w80 ">
      ...
      <span className="mb-3 flex justify-between border-b border-gray-200 pb-1">
        ...
        <X className="bg-gray-200 p-1 rounded-full" strokeWidth={1.75} size={22}/>
      </span>
        ...
        <div className="flex justify-center items-center gap-1 md:gap-4 pt-3 ">
            <small className=" rounded border border-black px-2 py-1 font-medium bg- text-">View Profile</small>
            <small className="border border-black rounded px-2 py-1 ml-3 md:ml-0  font-medium text-white bg-black">Let's Chat</small>
        </div>
    </div>
    </div>
  )
