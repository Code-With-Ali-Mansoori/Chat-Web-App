  ...
  return (
    <div className=" h-full  w-full">
        ...
        <div className="border-b border-gray-400 flex justify- items-center gap-1 py-3 px-2">
            <div className="w-fit "><ChevronLeft strokeWidth={1.5} /></div>
            <div className="flex items-center  gap-2 w-4/5">
                ...
                <div className="flex flex-col ">
                    <small className="font-medium md:hidden">Ali_Mansoori123</small>
                    <big className="font-medium hidden md:inline">Ali_Mansoori123</big>
                    <small className="text-left text-green-500">online</small>
                </div>
            </div>
            <div className="flex w-1/5 justify-center items-center gap-4 mr-2">     
                    <div><Phone strokeWidth={1.25} /></div>
                    <div><Video strokeWidth={1.25} size={28}/></div>
            </div>
        </div>
        ...
        <div className=" pt h-fit w-full">
            <div className="h-12 pt-3 border-gray-400 rounded-2xl gap-2 px-3 flex justify-evenly items-center mx-2">
                ...
                <div className=" flex justify-center items-center gap-3">
                    <div><Images className="text-gray-500" strokeWidth={1.25} /></div>
                    <div className="flex justify-center items-center gap-2 border px-2 py-1 border-gray-400  rounded md:rounded-2xl">
                        <button>Send </button>
